...
const mockBook = {
    ...
    description: "Set in the summer of 1922, The Great Gatsby follows Nick Carraway, a young Yale graduate and World War I veteran from the Midwest who moves to Long Island in 1922, intending to work in the bond business.",
                        ...
                        <Grid item xs={12} md={8}>
                            <Stack spacing={3}>
                                ...
                                <Box>
                                    ...
                                    <Stack spacing={1}>
                                        <Typography><strong>ISBN-13:</strong> {book.isbn13}</Typography>
                                        <Typography><strong>Publication Year:</strong> {book.publication}</Typography>
