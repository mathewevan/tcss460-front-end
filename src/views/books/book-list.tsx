        ...
        <MainCard>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={4}>
              <Card>
                <CardMedia component="img" image={book1.image} alt={book1.title} sx={{ height: 400, objectFit: 'cover' }} />
              </Card>
            </Grid>
            ...
            <Grid item xs={12} md={8}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <Stack spacing={1}>
                    <Typography>
                      <strong>ISBN-13:</strong> {book1.isbn13}
                    </Typography>
                    <Typography>
                      <strong>Publication Year:</strong> {book1.publication}
                    </Typography>
                    <Typography>
                      <strong>Cover:</strong> {book1.image}
                    </Typography>
                  </Stack>
                </Box>
              </Stack>
            ...
            <Grid item xs={12} md={8}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <Stack spacing={1}>
                    <Typography>
                      <strong>ISBN-13:</strong> {book2.isbn13}
                    </Typography>
                    <Typography>
                      <strong>Publication Year:</strong> {book2.publication}
                    </Typography>
                    <Typography>
                      <strong>Cover:</strong> {book2.image}
                    </Typography>
                  </Stack>
                </Box>
              </Stack>
            ...
            <Grid item xs={12} md={8}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <Stack spacing={1}>
                    <Typography>
                      <strong>ISBN-13:</strong> {book3.isbn13}
                    </Typography>
                    <Typography>
                      <strong>Publication Year:</strong> {book3.publication}
                    </Typography>
                    <Typography>
                      <strong>Cover:</strong> {book3.image}
                    </Typography>
                  </Stack>
                </Box>
              </Stack>
            ...
            <Grid item xs={12} md={8}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <Stack spacing={1}>
                    <Typography>
                      <strong>ISBN-13:</strong> {book4.isbn13}
                    </Typography>
                    <Typography>
                      <strong>Publication Year:</strong> {book4.publication}
                    </Typography>
                    <Typography>
                      <strong>Cover:</strong> {book4.image}
                    </Typography>
                  </Stack>
                </Box>
              </Stack>
            ...
            <Grid item xs={12} md={8}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <Stack spacing={1}>
                    <Typography>
                      <strong>ISBN-13:</strong> {book5.isbn13}
                    </Typography>
                    <Typography>
                      <strong>Publication Year:</strong> {book5.publication}
                    </Typography>
                    <Typography>
                      <strong>Cover:</strong> {book5.image}
                    </Typography>
                  </Stack>
                </Box>
              </Stack>
